            ...
            for user in users:
                try:
                    ...
                    recent_completions = PrayerCompletion.query.filter(
                        ...
                        PrayerCompletion.is_completed == True
                    ).all()
                    ...
                    errors += 1
                    print(f"Error checking consistency for user {user.email}: {str(e)}")
                    continue
    ...
    try:
        ...
        for user in users:
            try:
                ...
                errors += 1
                print(f"Error generating weekly report for user {user.email}: {str(e)}")
                continue
